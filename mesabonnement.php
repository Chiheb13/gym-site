...
<br><br><br><br>
<div id="coach-container" class="coach-container">
<?php

include("connextion.php");
$id = $_GET['id']; 
$sql = "SELECT * FROM monabonnement where id_user=$id" ;
$result = mysqli_query($con, $sql);
while ($row = mysqli_fetch_assoc($result)) {
    echo '<div class="coach-card">';
    
    echo "<p>$row[nom_abonnement]</p>" ;
    echo"<hr></hr>";
