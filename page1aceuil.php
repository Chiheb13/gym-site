...
<head>
    ...
    <link rel="stylesheet" href="/projetserveur/styleprojet/stylepage1aceuil.css">
</head>
<body>
  ...
  <div class="container">
    <div class="d-flex flex-wrap align-items-center justify-content-center justify-content-lg-start">
      ...
      <ul class="nav col-12 col-lg-auto me-lg-auto mb-2 justify-content-center mb-md-0">
        ...
        <li><a href="sports.php" class="nav-link px-2 text-white">check sports</a></li>
        <li><a href="pagecoaches.php" class="nav-link px-2 text-white" id="coaches">check coaches</a></li>
        <li id="about"><a href="aboutus.php" class="nav-link px-2 text-white">FAQ</a></li>
      </ul>

      <div class="text-end" style="margin-left:70;">
        <button type="button" class="btn btn-outline-light me-2"><a href="login.php" style="text-decoration:none;color:black;">Login</a></button>
        <button type="button" class="btn btn-warning"><a href="user.php" style="text-decoration:none;color:white;"> Sign-up</a></button>
      </div>
    </div>
  </div>
  <div class="motivation-text" style="left:190px;">
        ...
        <p id="motivation-paragraph"></p>
            ...
            <div  >
                <button style="bottom:380px;" class="btn  btn-get-started" ><a id="buttton-get-started"  href="login.php">GET STARTED</a></button>
            </div>
...
<blockquote class="blockquote">
  ...
  <footer class="py-6 custom-container-bg" id="mu-footer "style="bottom:-1000px;">
