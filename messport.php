...
<head>
    ...
    <link rel="stylesheet" href="/projetserveur/styleprojet/stylemessport.css">
</head>
<body>
...
<div class="container ecrit">
  <div class="d-flex flex-wrap align-items-center justify-content-center justify-content-lg-start">
    ...
    <ul class=" nav col-12 col-lg-auto me-lg-auto mb-2 justify-content-center mb-md-0" style="background-color: rgba(0, 0, 0, 0.3); border-radius: 10px;height:40px; ">
      ...
      <li style="position: relative; left: 470px;"><div id='dropdown1' class="js-scrollTo dropdown " style="margin-left: 20px;">
...
<h2 class="page-title"><center>Your Sports</center></h2>
<div id="sport-container" class="sport-container">
<?php

include("connextion.php");

$id = $_GET['id']; 
$sql = "SELECT * FROM monsport where iduser=$id" ;
$result = mysqli_query($con, $sql);

while ($row = mysqli_fetch_assoc($result)) {
    echo '<div class="sport-card">';
    echo '<img src="' . $row['imagesport'] . '" alt="' . $row['nomsport'] . '">';
    echo "<p>$row[nomsport]</p>" ;
    echo '</div>';
}
mysqli_close($con);
?>
