...
<head>
    ...
    <link rel="stylesheet" href="/projetserveur/styleprojet/stylemescoach.css">
</head>
<body > 
...
<div class="container ecrit">
  <div class="d-flex flex-wrap align-items-center justify-content-center justify-content-lg-start">
    ...
    <ul class=" nav col-12 col-lg-auto me-lg-auto mb-2 justify-content-center mb-md-0" style="background-color: rgba(0, 0, 0, 0.3); border-radius: 10px;height:40px; ">
      ...
      <li style="position: relative; left: 460px;bottom:-10px;">
...
<h2 class="page-title"><center>Your Coachs</center></h2>
...
$id = $_GET['id']; 
$sql = "SELECT * FROM mes_coach where user_id=$id" ;
$result = mysqli_query($con, $sql);

while ($row = mysqli_fetch_assoc($result)) {
    echo '<div class="coach-card">';
    echo '<img src="' . $row['image'] . '" alt="' . $row['nom_coach'] . '">';
    echo "<p>$row[nom_coach]</p>" ;
    echo "<spam class='sit' style='color:orange'>$row[situation]</spam>";
    echo '</div>';

echo "<script>

var b=document.querySelectorAll('.sit');
b.forEach(function(b) {
  
  if (b.innerText == 'accepter') {
    b.style.color = 'green';
}
  if (b.innerText == 'refuser') {
      b.style.color = 'red';
  }
