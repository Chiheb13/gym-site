...
<link rel="stylesheet" href="/projetserveur/styleprojet/styleabonnementpage.css">
...
$(document).ready(function(){
    ...
    <p id="titre">ABONNEMENTS ET TARIFS</p>
...
while ($row = mysqli_fetch_assoc($result)) {
    ...
    echo '<p>' . $row['price'] . '</p>';
    echo "<a href='ajoutabonnement.php?id_abonnement=$row[id_abonnement]' class='btn btn-primary '>GET IT</a>";
    echo '</div>';
}
